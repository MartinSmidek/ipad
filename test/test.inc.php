<?php # (c) 2022 Martin Smidek <martin@smidek.eu>
  ...
  $dbg_info= (object)array(
    'src_path'  => array('test',"ezer$ezer_version") // poloha a preference zdrojových modulů
    );

  // specifické PHP moduly
  $app_php=   array("ezer$ezer_version/server/comp2.php");
  
  // aplikace se startem v podsložce
  require_once("ezer$ezer_version/ezer_ajax.php");
